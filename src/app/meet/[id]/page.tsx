...
import { ArrowLeft, Copy, Clock, Check, AlertCircle } from 'lucide-react';
...
export default function MeetingRoom() {
  ...
  // Lấy tên người dùng để đưa vào Jitsi tự động
  useEffect(() => {
  ...
  // Cấu trúc URL nhúng tối ưu của Jitsi (Tự động điền tên người tham gia)

...
export default function GizmoHubDashboard() {
  ...
  useEffect(() => {
    ...
    // Đóng danh sách tìm kiếm khi click ra ngoài
  ...
  const handleGlobalSearch = async (query: string) => {
    ...
    // Tìm kiếm đồng thời trên nhiều bảng
